...
Create `.workloop/memory.md` from `../workloop/assets/memory.md` only when the project first needs Workloop state. Update it after review pass; write no new row when there is no qualifying lesson.
